...
const Sidebar = ({ onSelectOption, sector, industry, fullTimeEmployees, marketCap, companyName, companySite, currency }) => {
    ...
    <div className="flex h-screen">
      <div className='bg-[#0b082a] px-5' style={{ width: `${width}px`, transition: isResizing ? 'none' : 'width 0.2s' }}>
        ...
        <div className='flex-col items-center gap-[15px] py-4 cursor-pointer border-b border-[#EDEDED] border-opacity-30'>
          <label htmlFor="dropdown" className='text-[14px] leading-[20px] py-[20px] pr-[20px] font-semibold text-[#c7cad8]'>Select an option:</label>
          <select
            id="dropdown"
