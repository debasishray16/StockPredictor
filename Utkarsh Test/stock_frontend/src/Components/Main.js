      ...
      <div className='flex mt-[22px] w-full gap-[30px]'>
        <div className='basis-[70%] border bg-[#5848d3] shadow-md cursor-pointer rounded-[4px]'>
          ...
          <div>
            ...
            >
              <CartesianGrid strokeDasharray="3 2" fill='#1A154F'/>
              <XAxis dataKey="name" tick={{ fill: '#e6e7ec' }} tickLine={{ stroke: '#e6e7ec' }}/>
              <YAxis tick={{ fill: '#e6e7ec' }} tickLine={{ stroke: '#e6e7ec' }} />
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="pv" stroke="#DFB729" activeDot={{ r: 8 }} />
              <Line type="monotone" dataKey="uv" stroke="#A720C4" />
            </LineChart>
          </div>
        </div>
      </div>
